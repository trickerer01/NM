...
__all__ = (
    'filtered_tags', 'get_matching_tag', 'register_item_tags', 'register_item_description', 'register_item_comments',
    'try_parse_id_or_group', 'dump_item_info', 'valid_extra_tag', 'is_filtered_out_by_extra_tags', 'unite_separated_tags'
)
...
def dump_item_info() -> None:
    """Saves tags and descriptions for each subfolder in scenario and base dest folder based on registered item info"""
