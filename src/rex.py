...
RAW_TAGS_REPLACEMENTS = {
    ...
    re_compile(r'(t(?:hree|wo)|f(?:o(?:re|ur)|ive)|\d+?),(some)(,|$)'): r'\1\2\3',
    re_compile(r'(fore|horse|pony),(girls?|plays?)(,|$)'): r'\1\2\3',
    re_compile(r'(bl(?:ack|ue)|dark|gre(?:en|y)|pale|p(?:ink|urple)|white),(skin)'): r'\1 \2',
    re_compile(r'([^,]+),(job)(,|$)'): r'\1\2\3',
    re_compile(r'([^,]+),(boys?|girls?|m[ae]n)(,|$)'): r'\1 \2\3',
    re_compile(r'([^\d,]+),(\d+)(,|$)'): r'\1 \2\3',
    ...
    re_compile(r'(baldur(?:\'?s)?),(gate)(?:,(\d))?(,|$)'): r'\1 \2 \3\4',
    re_compile(r'(being),([a-z]+ed)'): r'\1 \2',
    re_compile(r'(belly),(bulge)'): r'\1 \2',
    re_compile(r'(big),(hero),(\d)?(,|$)'): r'\1 \2 \3\4',
    ...
    re_compile(r'(group),(sex)(,|$)'): r'\1 \2\3',
    ...
    re_compile(r'(mind),(break|control)'): r'\1 \2',
    ...
    re_compile(r'(resident),(evil)(?:,(village|\d))?(,|$)'): r'\1 \2 \3\4',
    ...
    re_compile(r'(silent),(hill)(?:,(\d))?(,|$)'): r'\1 \2 \3\4',
    ...
    re_compile(r'(star),(wars)(?:,(\d))?(,|$)'): r'\1 \2 \3\4',
    ...
    re_compile(r'(the),(incredibles|sims|witch(?:er)?)(?:,(\d))?(,|$)'): r'\2 \3\4',
