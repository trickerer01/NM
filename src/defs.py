...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        self.uploader = None  # type: Optional[str]
    ...
    def read(self, params: Namespace, pages: bool) -> None:
        ...
        self.playlist_id, self.playlist_name = (
            self.playlist_id, getattr(params, 'playlist_name')
        ) if hasattr(params, 'playlist_name') else (self.playlist_id, self.playlist_name)
