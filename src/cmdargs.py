...
from defs import (
    ...
    HELP_ARG_DUMP_INFO, HELP_ARG_TIMEOUT, HELP_ARG_UPLOADER, HELP_ARG_VERSION,
    QUALITIES, DEFAULT_QUALITY, HELP_ARG_QUALITY, HELP_ARG_PLAYLIST,
...
from validators import (
    ...
    log_level, positive_int, valid_lookahead, valid_duration,
)
...
def prepare_arglist_pages(args: Sequence[str]) -> Namespace:
    ...
    arggr_pl_upl.add_argument('-favourites', metavar='#username', default='', help=HELP_ARG_FAVORITES)
