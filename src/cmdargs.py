...
from defs import (
    ...
    HELP_ARG_DUMP_INFO, HELP_ARG_VERSION,
    HELP_ARG_CONTINUE, HELP_ARG_UNFINISH, APP_NAME, APP_VERSION, UTF8, HelpPrintExitException,
)
...
def prepare_arglist_pages(args: Sequence[str]) -> Namespace:
    ...
    arggr_playlist.add_argument('-playlist_name', metavar='#username', default='', help=HELP_ARG_PLAYLIST)
