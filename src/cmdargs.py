...
def prepare_arglist_pages(args: Sequence[str]) -> Namespace:
    ...
    # par_cmd.add_argument('-search_tag', metavar='#tags...', default='', help='', type=valid_tags)
    # par_cmd.add_argument('-search_art', metavar='#artists...', default='', help='', type=valid_artists)
    # par_cmd.add_argument('-search_cat', metavar='#catergories...', default='', help=HELP_SEARCH_ACT, type=valid_categories)
