...
RAW_TAGS_REPLACEMENTS = {
    re_compile(r'([^,]+),([oOiI][fnr]),([^,]+)'): r'\1 \2 \3',
    re_compile(r'([tT]hree|[fF]our|[fF]ive|\d+?),([sS]ome)'): r'\1\2',
    re_compile(r'([aA]ll),([fF]ours?)'): r'\1 \2',
    re_compile(r'([aA]pex),([lL]egends?)'): r'\1 \2',
    re_compile(r'([bB]elly),([bB]ulge)'): r'\1 \2',
    re_compile(r'([cC]assie),([cC]age)'): r'\1 \2',
    re_compile(r'([cC]laire),([rR]edfield)'): r'\1 \2',
    re_compile(r'([cC][ou]m+?ing),([sS]oon)'): r'\1 \2',
    re_compile(r'([dD]ogg?y),([sS]tyle)'): r'\1 \2',
    re_compile(r'([dD]ragon),([bB]allz?)'): r'\1\2',
    re_compile(r'([fF]inal),([fF]antasy)(?:,(x[^,]{2}))?'): r'\1 \2 \3',
    re_compile(r'([gG]enshin),([iI]mpact)'): r'\1 \2',
    re_compile(r'([gG]ang),((?:[bB]ang|[rR]ape))'): r'\1\2',
    re_compile(r'([gG]rand),([cC]upido)'): r'\1\2',
    re_compile(r'([gG]roup),([sS]ex)'): r'\1 \2',
    re_compile(r'([hH]ard),([cC]ore)'): r'\1\2',
    re_compile(r'([hH]orse),([cC]ock)'): r'\1\2',
    re_compile(r'([jJ]aina),([pP]roudmoore)'): r'\1 \2',
    re_compile(r'([jJ]ill),([vV]alentine)'): r'\1 \2',
    re_compile(r'([lL]ara),([cC]roft)'): r'\1 \2',
    re_compile(r'([mM]arie),([rR]ose)'): r'\1 \2',
    re_compile(r'([mM]ortal),([cCkK]ombat)'): r'\1 \2',
    re_compile(r'([rR]esident),([eE]vil)'): r'\1 \2',
    re_compile(r'([sS]amus),([aA]ran)'): r'\1 \2',
    re_compile(r'([sS]econd),([lL]ife)'): r'\1 \2',
    re_compile(r'([sS]oft),([cC]ore)'): r'\1\2',
    re_compile(r'([sS]tomach),([bB]ulge)'): r'\1 \2',
    re_compile(r'([sS]treet),([fF]ighter)'): r'\1 \2',
    re_compile(r'([sS]ub[^,]*),([^,]+)'): r'\1 \2',
    re_compile(r'([tT]ifa),([lL]ockhart)'): r'\1 \2',
    re_compile(r'([tT]ina),([aA]rmstrong)'): r'\1 \2',
    re_compile(r'([tT]riss),([mM]erigold)'): r'\1 \2',
}
