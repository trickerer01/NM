...
def parse_arglist(args: Sequence[str]) -> Namespace:
    ...
    pcpgm2.add_argument('-favourites', metavar='#username', default=0, help=HELP_ARG_FAVORITES, type=positive_nonzero_int)
    pcpgm2.add_argument('-uploader', metavar='#username', default='', help=HELP_ARG_UPLOADER)
